...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TbAuthService, [{
        ...
        args: [{
                ...
                type: Inject,
                args: ['env']
            }] }, { type: i1$1.HttpClient }, { type: i0.Injector }, { type: i1.MatDialog }]; }, null); })();
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TbAuthGuard, [{
    ...
    }], function () { return [{ type: TbAuthService }, { type: i2$2.Router }, { type: undefined, decorators: [{
                type: Inject,
                args: ['env']
            }] }]; }, null); })();
