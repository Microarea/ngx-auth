...
export class TbLoginComponent {
    ...
    constructor(authService, router, dialog, renderer, route, doc) {
        ...
        if (this.languageIT) {
            ...
            this.otpResetTextMagoWeb = "Per poter reimpostare la tua autenticazione a due fattori è necessario contattare l'amministratore di MagoWeb";
        }
        else {
            ...
            this.otpResetTextMagoWeb = "To reset your two-factor authentication you need to contact the MagoWeb administrator";
        }
