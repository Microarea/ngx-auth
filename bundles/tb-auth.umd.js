(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('moment'), require('@angular/core'), require('@angular/router'), require('@angular/common'), require('@angular/forms'), require('@progress/kendo-angular-inputs'), require('@progress/kendo-angular-buttons'), require('@progress/kendo-angular-dropdowns')) :
    typeof define === 'function' && define.amd ? define('@tb/auth', ['exports', '@angular/common/http', 'rxjs', 'rxjs/operators', 'moment', '@angular/core', '@angular/router', '@angular/common', '@angular/forms', '@progress/kendo-angular-inputs', '@progress/kendo-angular-buttons', '@progress/kendo-angular-dropdowns'], factory) :
    (factory((global.tb = global.tb || {}, global.tb.auth = {}),global.ng.common.http,global.rxjs,global.rxjs.operators,global.moment_,global.ng.core,global.ng.router,global.ng.common,global.ng.forms,global.kendoAngularInputs,global.kendoAngularButtons,global.kendoAngularDropdowns));
}(this, (function (exports,i1,rxjs,operators,moment_,i0,i2,common,forms,kendoAngularInputs,kendoAngularButtons,kendoAngularDropdowns) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TbAuthService = /** @class */ (function () {
        ...
        TbAuthService.prototype.getCompaniesForUser =
             ...
             */
            function (user) {
                return this.http.get(this.getSubsKeysForAccountUrl() + user).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    if (!res || !res.Result)
    ...
    var TbLogoffComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        TbLogoffComponent.ctorParameters = function () {
            return [
                { type: TbAuthService },
                { type: i2.Router }
            ];
    ...
    var TbAuthModule = /** @class */ (function () {
        ...
        TbAuthModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, kendoAngularInputs.InputsModule, kendoAngularButtons.ButtonsModule, kendoAngularDropdowns.DropDownsModule, i2.RouterModule.forRoot(routes)],
                        exports: [TbLoginComponent, TbLogoffComponent, i2.RouterModule]
                    },] }
        ];
        return TbAuthModule;
    }());
