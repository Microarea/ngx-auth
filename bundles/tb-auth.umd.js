(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('moment'), require('@angular/core'), require('@angular/router'), require('@angular/common'), require('@angular/forms'), require('@progress/kendo-angular-inputs'), require('@progress/kendo-angular-buttons')) :
    typeof define === 'function' && define.amd ? define('@tb/auth', ['exports', '@angular/common/http', 'rxjs', 'rxjs/operators', 'moment', '@angular/core', '@angular/router', '@angular/common', '@angular/forms', '@progress/kendo-angular-inputs', '@progress/kendo-angular-buttons'], factory) :
    (factory((global.tb = global.tb || {}, global.tb.auth = {}),global.ng.common.http,global.rxjs,global.rxjs.operators,global.moment_,global.ng.core,global.ng.router,global.ng.common,global.ng.forms,global.kendoAngularInputs,global.kendoAngularButtons));
}(this, (function (exports,i1,rxjs,operators,moment_,i0,i2,common,forms,kendoAngularInputs,kendoAngularButtons) { 'use strict';
    ...
    var TbAuthModule = /** @class */ (function () {
        ...
        TbAuthModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, kendoAngularInputs.InputsModule, kendoAngularButtons.ButtonsModule, i2.RouterModule.forRoot(routes)],
