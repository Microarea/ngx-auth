    ...
    getRedirectUrlForSubscription(accountName, subscriptionKey) {
        ...
        res => {
            ...
            res => {
                 ...
                 * @return {?}
                 */
                i => i.ServiceType === 'M4FRONTEND' || i.ServiceType === 'APP_FRONTEND')).map((/**
                 * @param {?} f
                 * @return {?}
                 */
                f => f.Url))[0];
